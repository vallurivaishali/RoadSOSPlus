...
export default function AuthorityProfilePage() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-white mb-2">Authority Profile</h1>
        <p className="text-slate-400">Manage your authority account details and settings.</p>
      </div>

      <div className="glass-card p-8">
        <div className="flex items-center gap-6 mb-8 border-b border-slate-700/50 pb-8">
          <div className="w-20 h-20 rounded-2xl bg-indigo-600/20 border border-indigo-500/30 flex items-center justify-center glow-indigo">
            <Shield className="w-10 h-10 text-indigo-400" />
          </div>
          <div>
            <h2 className="text-xl font-bold text-white">{user.full_name}</h2>
            <div className="flex items-center gap-2 mt-1">
              <span className="px-2 py-0.5 rounded text-xs font-medium bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 uppercase tracking-wider">
                {user.role}
              </span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-slate-800/50 border border-slate-700">
                ...
                <div>
                  <p className="text-sm text-slate-400">Authority ID</p>
